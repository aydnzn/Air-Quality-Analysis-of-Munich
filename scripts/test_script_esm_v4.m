%% ESM
%% SCRIPT for generating the 30 concentration maps for month JUNE
%% In the end you get 30 concentration maps and then you can create an animation with these 30 images.
%% My animation is called 'anim_v2.mp4'
close all;
clc;
clear;
...
for day=1:30
    ...
    set(gca,'Fontsize',18);
    if dummy ==8 % this dummy variable is for writing the title of each day
        dummy=1;
    end
    title(days(dummy));
    dummy = dummy+1;
    pause(1);
    print(f,num2str(day), '-dpng');
